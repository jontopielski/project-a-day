...
while ( total_boil_time > 0 ):
    print 'Time left until done cooling:', total_boil_time
    time.sleep(1)
    total_boil_time -= 1
    if ( total_boil_time == 10 ):
        os.system( ' say "TEN SECONDS REMAINING ON COOLDOWN" ' )
...
while ( total_steep_time > 0 ):
    ...
    if ( steep_time_passed == 60 ):
        os.system( ' say "POUR THE WATER AND STIR THE COFFEE!" ' )
...
os.system( ' say "PRESS THE FRENCH PRESS AND ENJOY YOUR VERVE!" ' )
